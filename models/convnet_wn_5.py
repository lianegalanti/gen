...
class ConvNet_WN_5(nn.Module):
    def __init__(self, settings):
        super(ConvNet_WN_5, self).__init__()
        ...
        self.fc = nn.Linear(self.width * 23 * 23, settings.num_output_classes)
        
        self.all_layers = [self.conv1, self.conv2, self.conv3, self.conv4,self.conv5, self.fc]
        self.degs = [2, 2, 2, 2,2]
        self.depth = 6
        self.conv_depth = 5
        self.fc_depth = 1
...
def convnet_wn_5(settings):
    return ConvNet_WN_5(settings)