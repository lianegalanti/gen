...
class ConvNet_WN_3(nn.Module):
    def __init__(self, settings):
        super(ConvNet_WN_3, self).__init__()
        ...
        self.fc = nn.Linear(self.width * 25 * 25, settings.num_output_classes)
...
def convnet_wn_3(settings):
    return ConvNet_WN_3(settings)